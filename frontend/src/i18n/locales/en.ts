export default {
  ...
  printers: {
    ...
    modal: {
      ...
      priceHelp: 'Purchase price for machine cost calculation',
      lifespanHours: 'Estimated Lifespan (hours)',
      lifespanPlaceholder: 'e.g. 5000',
      lifespanHelp: 'Estimated total print hours for depreciation',
  ...
  stats: {
    ...
    totalMachineCost: 'Total Machine Cost',
